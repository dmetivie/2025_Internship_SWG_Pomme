...
##### ESTIMATION #####
"""
    Log_Likelihood_AR(x::AbstractVector,Estimators::AbstractVector)
...
"""
function Log_Likelihood_AR(x::AbstractVector, Estimators::AbstractVector)
...
"""
function LL_AR_Estimation(x::AbstractVector, p::Integer, Estimators::AbstractVector=[zeros(p); 1e-15], algo=NelderMead())
